		...
		echo '
			<div class="dropdown">
			  ...
			  <ul class="dropdown-menu form-control-sm" role="menu" aria-labelledby="menu1">
			    <li style="padding-left:10px" role="presentation"><a role="dropdown-item" href="?cont=account&action=confirmPayment">Confirm payment</a></li>
			    <li style="padding-left:10px" role="presentation"><a role="dropdown-item" href="?cont=account&action=showHistory">Order history</a></li>
